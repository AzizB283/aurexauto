...
const benefits = [
  ...
  { icon: TrendingUp, title: "Boost Revenue", description: "Never miss a lead" },
  { icon: Shield, title: "Enterprise-Grade", description: "Secure & reliable" },
];

const testimonials = [
  {
    quote: "AurexAuto transformed our practice. We're saving 20 hours per week.",
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 py-12">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-5">
            ...
            <Link href="/portfolio" data-testid="link-hero-portfolio">
              <Button size="lg" variant="outline" className="w-full sm:w-auto" data-testid="button-hero-portfolio">
                View Case Studies
              </Button>
            </Link>
          </div>
      ...
      <section className="py-20 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">Automation Solutions</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {features.map((feature, index) => (
              <Card key={index} className="bg-card/50 border-border/50 hover-elevate" data-testid={`card-feature-${index}`}>
      ...
      <section className="py-20 sm:py-24 bg-card/30 border-y border-border/50">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground">Results that transform your bottom line</p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="bg-card/50 border-border/50" data-testid={`testimonial-${index}`}>
                <CardContent className="p-6">
      ...
      <section className="py-20 sm:py-24 bg-gradient-to-b from-card/50 to-background border-t border-border/50">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto mb-8">
            Join hundreds of businesses saving time and money with our automation solutions
          </p>
