...
export default function BookingBotForWebsites() {
  return (
    <div>
      <Seo
        title={"Embedded Booking Bot for Websites — Chat & Voice Bookings | AurexAuto"}
        description={"Accept bookings on your website using an embeddable chat or voice bot. Includes an admin panel to manage staff, services, and booking logs."}
        pathname="/booking-bot-for-websites"
      />

      <section className="py-20 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          <h1 className="text-4xl font-bold mb-4">Embedded Booking Bot for Websites</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              <CardHeader className="flex items-start gap-3">
                ...
                <div>
                  <CardTitle className="text-base font-semibold">Chat & Voice Booking</CardTitle>
                  <CardDescription className="text-sm">Conversational flows that capture service, staff choice, date/time and contact details.</CardDescription>
                </div>
              </CardHeader>
            </Card>
            ...
            <Card>
              <CardHeader className="flex items-start gap-3">
                ...
                <div>
                  <CardTitle className="text-base font-semibold">Admin & Staff Management</CardTitle>
                  <CardDescription className="text-sm">Create staff, assign services, view booking logs and export CSV.</CardDescription>
                </div>
              </CardHeader>
            </Card>
            ...
            <Card>
              <CardHeader className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-sm">Calendar sync (Google/Outlook), webhooks for CRM, optional payment integration.</CardDescription>
                </div>
              </CardHeader>
            </Card>
          </div>
      ...
      <section className="py-12 sm:py-16 bg-card/30 border-t border-border/50">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Hosted — Starter</CardTitle>
                <CardDescription>$99/mo — basic bot, admin access, single staff, email support.</CardDescription>
              </CardHeader>
            </Card>

            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Hosted — Business</CardTitle>
                <CardDescription>$249/mo — multi-staff, calendar integrations, priority support.</CardDescription>
              </CardHeader>
            </Card>

            <Card>
              <CardHeader>
                <CardTitle className="text-lg">Custom Build</CardTitle>
                <CardDescription>$3k+ one-time — custom admin, source handover, optional SLA.</CardDescription>
              </CardHeader>
            </Card>
          </div>
        </div>
